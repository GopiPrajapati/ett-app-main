...
import {submitYettReview} from '../../../redux/actions';
  ...
  return (
    <SafeAreaView style={styles.safeAreaContainer} edges={['top']}>
      ...
      <Header
        ...
        leftText={strings.share_feedback}
      />
...
const createStyle = colors =>
  StyleSheet.create({
    safeAreaContainer: {
      flex: 1,
      backgroundColor: colors.shareFeedbackTheme.mainBackgroundColor,
    },
    container: {
      flex: 1,
      paddingHorizontal: sizes.paddingHorizontal,
      backgroundColor: colors.shareFeedbackTheme.containerBackgroundColor,
    ...
    questionText: {
      ...
      color: colors.shareFeedbackTheme.color,
    },
    starsContainer: {
      flexDirection: 'row',
    },
    ...
    divider: {
      backgroundColor: colors.shareFeedbackTheme.dividerColor,
    },
    inputContainer: {
