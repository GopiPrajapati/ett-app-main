...
const SelectPreferencesScreen = () => {
  ...
  useEffect(() => {
    Loader.show({key: Routes.SELECT_PREFERENCES_SCREEN});
    dispatch(
      getPreference({
        SuccessCallback: response => {
          setCategories(response.data || []);
          Loader.hide({key: Routes.SELECT_PREFERENCES_SCREEN});
        },
      ...
      <SafeAreaView style={styles.safeAreaContainer} edges={['top', 'bottom']}>
        ...
        <View style={styles.container}>
          <ScrollView
            ...
            <Text style={styles.selectWhatYouLikeText}>
              {strings.select_what_you_like}
            </Text>
            <Spacing size={24} />
            <View style={styles.selectPrefContainer}>
...
const createStyle = colors =>
  StyleSheet.create({
    mainContainer: {
      flex: 1,
      backgroundColor: colors.selectPreferencesTheme.mainBackgroundColor,
    },
    backgroundImage: {
      width: '100%',
      height: '100%',
    ...
    selectPrefContainer: {
      ...
      backgroundColor:
        colors.selectPreferencesTheme.selectPrefContainerBackgroundColor,
    ...
    categoryItemText: {
      ...fontStyles.archivoRegular,
      fontSize: fontPixel(14),
      color: colors.selectPreferencesTheme.color,
    },
    icon: {
      width: normalize(20),
      height: normalize(20),
    ...
    unselect: {
      backgroundColor: colors.selectPreferencesTheme.itemBackgroundColor,
    },
    skip: {
      ...fontStyles.archivoRegular,
      fontSize: fontPixel(14),
